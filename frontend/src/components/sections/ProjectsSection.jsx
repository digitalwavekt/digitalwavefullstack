...
const projects = [
  ...
  },
  {
    ...
    category: 'CRM',
    description: 'Custom CRM for healthcare providers with patient management, appointment scheduling, and billing integration.',
  ...
  },
  {
    ...
    category: 'Mobile App',
    description: 'Cross-platform mobile application for food delivery with real-time tracking and multiple payment options.',
    tech: ['React Native', 'Firebase', 'Google Maps', 'PayU'],
  ...
  },
  {
    ...
    category: 'AI/ML',
    description: 'Intelligent chatbot powered by NLP for customer support with sentiment analysis and automated responses.',
  ...
  },
  {
    ...
    description: 'Complete student management portal with attendance, grades, and communication features for educational institutions.',
    tech: ['MERN Stack', 'Socket.io', 'JWT', 'Cloudinary'],
...
export default function ProjectsSection() {
  ...
  return (
    <section id="projects" className="relative py-24 section-padding" ref={ref}>
      <div className="max-w-7xl mx-auto">
        ...
        >
          <Link 
            to="/projects" 
            className="inline-flex items-center gap-2 px-8 py-3 rounded-xl border border-white/10 text-white hover:bg-white/5 transition-all duration-300"
          >
            View All Projects
