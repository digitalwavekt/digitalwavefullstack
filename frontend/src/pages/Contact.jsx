...
export default function Contact() {
  ...
  const contactInfo = [
    { icon: Phone, label: 'Phone', value: '+91 98765 43210', color: 'text-blue-400', bgColor: 'bg-blue-500/10', borderColor: 'border-blue-500/20' },
    { icon: Mail, label: 'Email', value: 'info@digitalwaveit.com', color: 'text-purple-400', bgColor: 'bg-purple-500/10', borderColor: 'border-purple-500/20' },
    { icon: MapPin, label: 'Address', value: '123 Tech Park, Sector 62, Noida, UP 201301', color: 'text-pink-400', bgColor: 'bg-pink-500/10', borderColor: 'border-pink-500/20' },
    { icon: Clock, label: 'Working Hours', value: 'Mon - Sat: 9:00 AM - 7:00 PM', color: 'text-green-400', bgColor: 'bg-green-500/10', borderColor: 'border-green-500/20' },
  ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get in touch with Digital Wave IT Solutions for web development, app development, CRM solutions, internships, and college projects." />
      </Helmet>
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                {contactInfo.map((item, i) => (
                  ...
                  >
                    <div className={`w-10 h-10 rounded-lg ${item.bgColor} border ${item.borderColor} flex items-center justify-center mb-3`}>
              ...
              <div className="glass rounded-2xl overflow-hidden border border-white/10 h-64 mb-8">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.1234567890123!2d77.3616!3d28.6139!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjjCsDM2JzUwLjAiTiA3N8KwMjEnNDEuOCJF!5e0!3m2!1sen!2sin!4v1234567890"
                  width="100%"
                  height="100%"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="website" className="bg-dark-800">Website Development</option>
                        <option value="app" className="bg-dark-800">Mobile App Development</option>
                        <option value="crm" className="bg-dark-800">CRM Solutions</option>
                        <option value="internship" className="bg-dark-800">Internship Program</option>
                        <option value="college-project" className="bg-dark-800">College Project</option>
